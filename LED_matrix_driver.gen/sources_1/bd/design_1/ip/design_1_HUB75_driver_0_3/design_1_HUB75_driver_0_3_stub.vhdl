...
entity design_1_HUB75_driver_0_3 is
  ...
  attribute core_generation_info of design_1_HUB75_driver_0_3 : entity is "design_1_HUB75_driver_0_3,HUB75_driver,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=HUB75_driver,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,g_BRIGHTNESS=10}";
...
architecture stub of design_1_HUB75_driver_0_3 is
  ...
  attribute black_box_pad_pin of stub : architecture is "i_clk,i_clk_enable,i_row_data_top[63:0],i_row_data_bottom[63:0],o_read_addr_top[4:0],o_read_addr_bottom[4:0],o_addr[3:0],o_rgb_0[2:0],o_rgb_1[2:0],o_latch,o_out_enable_n,o_clk";
