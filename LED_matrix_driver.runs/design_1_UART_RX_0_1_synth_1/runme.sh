...
HD_PWD='/home/adrianna/Git/LED_matrix_driver/LED_matrix_driver.runs/design_1_UART_RX_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_UART_RX_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_UART_RX_0_1.tcl
