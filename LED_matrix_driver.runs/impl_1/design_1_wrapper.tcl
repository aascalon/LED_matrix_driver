namespace eval ::optrace {
  variable script "/home/adrianna/Git/LED_matrix_driver/LED_matrix_driver.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {/home/adrianna/.Xilinx/Vivado/2024.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part digilentinc.com:basys3:part0:1.2 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /home/adrianna/Git/LED_matrix_driver/LED_matrix_driver.cache/wt [current_project]
  set_property parent.project_path /home/adrianna/Git/LED_matrix_driver/LED_matrix_driver.xpr [current_project]
  set_property ip_output_repo /home/adrianna/Git/LED_matrix_driver/LED_matrix_driver.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /home/adrianna/Git/LED_matrix_driver/LED_matrix_driver.runs/synth_1/design_1_wrapper.dcp
